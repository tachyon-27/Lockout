...
const ProtectedRoutes = ({ allowed }) => {
  ...
  if (!allowed) {
    return (
      <div className="fixed inset-0 w-screen min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-black via-gray-900 to-purple-900 text-white text-center p-10">
